...
class TestTriangles(unittest.TestCase):
    ...
    def testMarriageBeforeDivorce1(self):
        self.assertTrue(fam1.marriage_before_divorce())

    def testMarriageBeforeDivorce2(self):
        self.assertEqual(fam1.marriage_before_divorce(), True)

    def testMarriageBeforeDivorce3(self):
        self.assertNotEqual(fam1.marriage_before_divorce(), False)

    def testMarriageBeforeDivorce4(self):
        self.assertIsNot(fam1.marriage_before_divorce(), " ")

    def testMarriageBeforeDivorce5(self):
        self.assertIsNotNone(fam1.marriage_before_divorce())
